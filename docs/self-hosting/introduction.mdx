...
You can [host your own roots](../zerotier/moons) in addition to ZeroTier's, but you can't not use ZeroTier's (unless your are a Very Large Enterprise Customer).
